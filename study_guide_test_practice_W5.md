1. Choose the correct statement(s) about Binary Search: D
...
2. Which statement(s) about Promises is/are correct? B
...
3. Choose the correct statement(s) about speeding up websites: C, E
...
4. Choose the correct statement(s) about Web Security: D, G, H
...
5. Choose the correct statement(s) about searching algorithms: A, C
...
6. Choose the correct statement(s) about Promises: B, F
...
7. Choose the correct statement(s) about the DOM: B, C
A) Tags placed after the closing tag won't be read by the browser
...
8. Which of these statement(s) about algorithms is/are correct? D, H
...
9. Which statement(s) about async/await is/are correct? B, C
...
10. Select the correct statement(s) about OOP. B, C, E, F, I
